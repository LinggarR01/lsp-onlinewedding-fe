...
function EditOrderModal({ isOpen, onClose, onEditOrder, orderData, catalogData }) {
  ...
  // Reset form ketika orderData berubah atau modal dibuka
  useEffect(() => {
    if (orderData && isOpen) {
      setFormData({
        id_catalogue: orderData.id_catalogue || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Data edit yang dikirim:', formData);

      await onEditOrder(formData, orderData.id_order);
    } catch (error) {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                {catalogData && catalogData.map((pkg) => (
